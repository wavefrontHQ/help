[[queryFunctionName type=header text=count()]] returns the number of reporting time series described by tsExpression.

Standard aggregation functions like [[queryFunctionName type=header text=count()]] interpolate data in each time series. The aggregation function itself is applied to the interpolated series.
