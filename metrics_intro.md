...
* Persistent metrics, which are retained for 18 months. By default, all ingested metrics are persistent but are convertible to ephemeral.
* Ephemeral metrics, which are retained for 28 days.
